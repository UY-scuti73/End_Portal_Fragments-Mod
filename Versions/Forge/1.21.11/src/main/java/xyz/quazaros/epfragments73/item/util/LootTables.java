...
public class LootTables {
    ...
    public static void register() {
        LootTableLoadEvent.BUS.addListener(LootTables::onLootTableLoad);
    }
    ...
    private static void onLootTableLoad(LootTableLoadEvent event) {
        ...
        if (id.equals(getPath("minecraft", "entities/elder_guardian"))) {
        ...
        if (id.equals(getPath("minecraft", "entities/wither"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
        ...
        if (id.equals(getPath("minecraft", "gameplay/piglin_bartering"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
        ...
        if (id.equals(getPath("minecraft", "chests/trial_chambers/reward_ominous_unique"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
        ...
        if (id.equals(getPath("minecraft", "archaeology/trail_ruins_rare"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
        ...
        if (id.equals(getPath("minecraft", "chests/ancient_city"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
        ...
        if (id.equals(getPath("minecraft", "chests/woodland_mansion"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
        ...
        if (id.equals(getPath("minecraft", "chests/desert_pyramid"))) {
            event.getTable().addPool(LootPool.lootPool()
                    .setRolls(ConstantValue.exactly(1))
